...
const PATHS: Record<string, string> = {
  ...
  card: 'M3.5 6.5h17a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1h-17a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1ZM2.5 10.5h19M6 14h3',
  tag: 'M3.5 10.8V4.5a1 1 0 0 1 1-1h6.3a1 1 0 0 1 .7.3l8.2 8.2a1 1 0 0 1 0 1.4l-6.3 6.3a1 1 0 0 1-1.4 0L3.8 11.5a1 1 0 0 1-.3-.7ZM7.8 7.8h.01',
  trash: 'M4 7h16M9.5 7V4.5h5V7M6.5 7l.9 12.6a1 1 0 0 0 1 .9h7.2a1 1 0 0 0 1-.9L17.5 7M10 11v6M14 11v6',
  power: 'M12 3.5v8M17.5 6.5a8 8 0 1 1-11 0',
};
